...
$payment = $conn->query("SELECT mp.*, s.name as student_name, s.id_no FROM miscellaneous_payments mp inner join student s on s.id = mp.student_id where mp.id = {$_GET['pid']}");
...
<head>
	...
	<title>Recibo de Pago Misceláneo</title>
	<style>
		* {
			margin: 0;
			padding: 0;
...
<body>
	<div class="receipt-container">
		...
		<div class="info-row">
			...
			<span class="info-value"><?php echo ucwords($row['student_name']) ?></span>
		</div>
		<div class="info-row">
		...
		<div class="summary-box">
			<div class="summary-row">
				<span>Concepto:</span>
				<span class="bold"><?php echo $row['concept'] ?></span>
			</div>
