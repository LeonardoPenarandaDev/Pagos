								...
								?>
									<tr>
										...
										<td class="text-center">
											<button class="btn btn-success certificate_student" type="button" data-student_id="<?php echo $row['student_id'] ?>" title="Generar Certificado"><i class="fa fa-certificate"></i></button>
...
<script>
	...
	$('.certificate_student').click(function() {
		window.open('student_certificate.php?id=' + $(this).attr('data-student_id'), '_blank')
	})
