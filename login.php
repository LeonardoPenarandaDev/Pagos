...
if($system->num_rows > 0){
	foreach ($system->fetch_array() as $k => $v) {
		$_SESSION['system'][$k] = $v;
	}
}
// }
...
<head>
	...
	<link rel="icon" type="image/x-icon" href="assets/uploads/logo2.png">
		...
		<div class="align-self-center w-100">
			...
			<div id="login-center" align="center">
				<div class="card col-md-3 ">
					<div class="card-body">
						<h1 class="text-center mb-5"><img src="assets/uploads/logo.jpg" width=50%></h1>
