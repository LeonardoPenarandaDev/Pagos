		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="card">
					...
					<button class="btn btn-success certificate_student" type="button" data-id="<?php echo $row['id'] ?>" title="Generar Certificado"><i class="fa fa-certificate"></i></button>
...
<script>
	...
	$('.certificate_student').click(function() {
		window.open('student_certificate.php?id=' + $(this).attr('data-id'), '_blank')
	})
